...
def main(config) -> None:
    ...
    plt.ylabel('Accuracy')
    plt.legend(loc=2)
    plt.savefig(plot_save_dir+'mean_model_comparisons2.png',dpi=500, bbox_inches='tight')
    ...
    plt.savefig(plot_save_dir+'relative_model_comparisons2.png',dpi=500, bbox_inches='tight')
    ...
    plt.savefig(plot_save_dir+'result_table2.png',dpi=500, bbox_inches='tight')
